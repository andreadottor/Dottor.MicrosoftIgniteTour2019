<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Insert.aspx.cs" Inherits="Dottor.WebFormApplication.Web.Cities.Insert" %>

<asp:Content ID="cphMain" ContentPlaceHolderID="MainContent" runat="server">
    <h2>Inserimento nuova città/evento</h2>

    <div class="form-group">
        <asp:Label runat="server" AssociatedControlID="txtName">Nome</asp:Label><asp:RequiredFieldValidator runat="server" ControlToValidate="txtName" ErrorMessage="*" CssClass="text-danger"/>
